...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'x.m.', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'find value.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.751157.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, blog, science, tech', // 网站关键词 英文逗号隔开
